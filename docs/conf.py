...
sys.path.insert(0, os.path.abspath(str(Path(__file__).parent.parent / "src")))
print(sys.path[0])

import fmu.sumo.sim2sumo as sim2sumo
...
# release = fmu.sumo.sim2sumo.__version__
...
apidoc_excluded_paths = [
    "version.py",
    "hook_implementations/*.py",
    "config_jobs/*.py",
]
apidoc_separate_modules = True
apidoc_module_first = True
apidoc_extra_args = ["-H", "API reference for fmu.sumo.sim2sumo"]
...
# copyright = "Equinor " + str(current_year) + f" (fmu-sumo-sim2sumo release {release})"
...
htmlhelp_basename = "fmu-sumo-sim2sumo"
